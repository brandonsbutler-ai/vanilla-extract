...
|---|---|---|
| **Unit tests** (109) | `python3 -m unittest discover -s tests` | Logic errors in one function, and every past bug as a regression test |
| **Benchmark** | `python3 benchmark.py <dir>` | Extraction *quality*, scored against an independent implementation |
| **End-to-end verification** (178 checks) | `python3 verify_e2e.py` | Whether the product does what its documentation says |
...
- **178 passing checks means the documented claims hold today, on this machine, for these
