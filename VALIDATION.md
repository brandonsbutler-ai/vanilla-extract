...
| **End-to-end verification** (177 checks) | `python3 verify_e2e.py` | Whether the product does what its documentation says |
...
- **177 passing checks means the documented claims hold today, on this machine, for these
...
python3 verify_e2e.py                       # 177 end-to-end claim checks
